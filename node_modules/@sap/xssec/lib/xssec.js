...
exports.createSecurityContextCC = deprecate(createSecurityContext,
    'xssec.createSecurityContextCC: Use xssec.createSecurityContext instead');
            ...
            function(error, result) {
                ...
                if (self.grantType !== constants.GRANTTYPE_CLIENTCREDENTIAL) {
                    ...
                    if (result.hasOwnProperty('ext_attr') && result.ext_attr.given_name !== undefined) {
                        self.userInfo.firstName = result.ext_attr.given_name;
                    } else {
                        self.userInfo.firstName = result.given_name; // jshint ignore:line
                    }
                    if (result.hasOwnProperty('ext_attr') && result.ext_attr.family_name !== undefined) {
                        self.userInfo.lastName = result.ext_attr.family_name;
                    } else {
                        self.userInfo.lastName = result.family_name; // jshint ignore:line
                    }
                    self.userInfo.email = result.email;
                    debugTrace('\nObtained logon name: ' + self.userInfo.logonName);
                    debugTrace('Obtained given name: ' + self.userInfo.firstName);
                    debugTrace('Obtained family name: ' + self.userInfo.lastName);
